...
export default class Checkout extends React.Component {
    render() {
        ...
        let env = NEXT_PUBLIC_PAYPAL_CLIENT_ENV; // you can set here to 'production' for production
        ...
        const client = {
            sandbox:    process.env.NEXT_PUBLIC_PAYPAL_CLIENT_ID,
            production: process.env.NEXT_PUBLIC_PAYPAL_CLIENT_ID,
        }
        ...
        return (
            ...
            <PaypalExpressBtn style={{size:"medium",color:"blue",shape:"rect",label:"checkout"}} env={env} client={client} currency={currency} total={total} onError={onError} onSuccess={onSuccess} onCancel={onCancel} />
            </div>
            </div>
        );
    }
